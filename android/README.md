...
```gradle
dependencies {
    implementation 'com.github.apiverve:dnsseccheck-api:1.1.14'
}
```
...
```java
import com.apiverve.dnsseccheck.DNSSECCheckerAPIClient;
import com.apiverve.dnsseccheck.APIResponse;
import com.apiverve.dnsseccheck.APIException;

// Initialize the client
DNSSECCheckerAPIClient client = new DNSSECCheckerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("domain", "cloudflare.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dnsseccheck](https://docs.apiverve.com/ref/dnsseccheck)
...
- **Documentation:** [https://docs.apiverve.com/ref/dnsseccheck](https://docs.apiverve.com/ref/dnsseccheck)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dnsseccheck-api/issues)
