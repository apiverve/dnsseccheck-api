...
namespace APIVerve\Dnsseccheck;
...
/**
 * Client for the DNSSEC Checker API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/dnsseccheck?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dnsseccheck';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DnsseccheckClient] {$message}\n";
        }
    }
}
