...
namespace APIVerve.API.DNSSECChecker
{
    ...
    /// <summary>
    /// Client for the DNSSECChecker API
    /// </summary>
    public class DNSSECCheckerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/dnsseccheck";
        ...
        public DNSSECCheckerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DNSSECCheckerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DNSSECCheckerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DNSSECCheckerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DNSSECCheckerQueryOptions options)
        {
        ...
        public ResponseObj Execute(DNSSECCheckerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DNSSECCheckerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DNSSECCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DNSSECCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DNSSECCheckerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DNSSECCheckerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DNSSECCheckerQueryOptions options)
        {
