...
const (
	baseURL        = "https://api.apiverve.com/v1/dnsseccheck"
	defaultTimeout = 30 * time.Second
)

// Client is the DNSSEC Checker API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new DNSSEC Checker API client.
...
// Execute makes a request to the DNSSEC Checker API with typed parameters.
//
