// Package dnsseccheck provides a Go client for the DNSSEC Checker API.
//
// For more information, visit: https://apiverve.com/marketplace/dnsseccheck?utm_source=go&utm_medium=readme
package dnsseccheck
...
// Request contains the parameters for the DNSSEC Checker API.
//
// Parameters:
//   - domain (required): string - The domain name to check DNSSEC configuration for [format: domain]
type Request struct {
...
// ResponseData contains the data returned by the DNSSEC Checker API.
...
// RecordsData represents the records object.
...
// DetailsData represents the details object.
